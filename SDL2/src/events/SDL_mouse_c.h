...
extern int SDL_SendMouseWheel(SDL_Window * window, SDL_MouseID mouseID, float x, float y, int continuousX, int continuousY, SDL_bool isContinuousSource, SDL_MouseWheelDirection direction);
